// Package worker Code generated by swaggo/swag. DO NOT EDIT
package worker
...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/distributed-configuration_pkg_models.Configuration"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "message: config updated",
                        "schema": {
                            "type": "object",
        ...
        "/config": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Current config version (ETag)",
                        "name": "If-None-Match",
                        "in": "header"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/distributed-configuration_pkg_models.AgentRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "distributed-configuration_pkg_models.AgentRequest": {
            "type": "object",
            "properties": {
                "host": {
                    "type": "string"
        ...
        "distributed-configuration_pkg_models.Configuration": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "object"
